...
site_table <- neon_site %>%
  select(site_id, site_name, dominant_nlcd_classes, latitude, longitude, elev_m, 
         mat_deg_c, map_mm, c_percent_soil, n_percent_soil, cn_ratio, netnmin_ugpergperday, 
...
site_range_table <- site_table %>%
  ...
  transmute(lat_range= paste(latitude_min, latitude_max, sep="-"),
         ...
         soil_cn_range = paste(cn_ratio_min, cn_ratio_max, sep="-"),
...
# also make frame of n count for acru at each site to add to figure
acru_n_n <- acru %>%
  count(site_id, taxon_id) %>%
  mutate(n_text=paste("n", n, sep="="))
...
``` {r fig 5 - intraspecific flexibility in foliar N among sites}
acru_n <- ggplot(acru, aes(x=fct_reorder(site_id, et_mm_avg), y=n_percent_foliar)) +
  ...
  geom_text(data=acru_n_n, aes(x=site_id, y=2.85, label=n_text),
            position=position_dodge(width=0.9)) +
...
list2_n <- ggplot(list2, aes(x=fct_reorder(site_id, et_mm_avg), y=n_percent_foliar)) +
  geom_boxplot() +
  geom_text(data=list2_n_letters, aes(x=x, y=3.05, label=letters), 
            position=position_dodge(width=0.9)) +
    geom_text(data=list2_n_n, aes(x=site_id, y=2.9, label=n_text),
            position=position_dodge(width=0.9)) +
  labs(x="Site", y="Foliar N (%)") +
...
litu_n <- ggplot(litu, aes(x=fct_reorder(site_id, et_mm_avg), y=n_percent_foliar)) +
  geom_boxplot() +
  geom_text(data=litu_n_letters, aes(x=x, y=3.35, label=letters), 
            position=position_dodge(width=0.9)) +
    geom_text(data=litu_n_n, aes(x=site_id, y=3.2, label=n_text),
            position=position_dodge(width=0.9)) +
  labs(x="Site", y="Foliar N (%)") +
...
qual_n <- ggplot(qual, aes(x=fct_reorder(site_id, et_mm_avg), y=n_percent_foliar)) +
  geom_boxplot() +
  geom_text(data=qual_n_letters, aes(x=x, y=3.25, label=letters), 
            position=position_dodge(width=0.9)) +
    geom_text(data=qual_n_n, aes(x=site_id, y=3.1, label=n_text),
            position=position_dodge(width=0.9)) +
  labs(x="Site", y="Foliar N (%)") +
...
quru_n <- ggplot(quru, aes(x=fct_reorder(site_id, et_mm_avg), y=n_percent_foliar)) +
  ...
  geom_text(data=quru_n_letters, aes(x=x, y=3, label=letters), 
            position=position_dodge(width=0.9)) +
    geom_text(data=quru_n_n, aes(x=site_id, y=2.85, label=n_text),
            position=position_dodge(width=0.9)) +
  labs(x="Site", y="Foliar N (%)") +
